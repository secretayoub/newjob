...
ActiveRecord::Schema.define(version: 20151203231818) do
  ...
  create_table "candidat_ads", force: :cascade do |t|
  ...
  create_table "candidats", force: :cascade do |t|
    ...
    t.string   "my_cv_file_name"
    t.string   "my_cv_content_type"
    t.integer  "my_cv_file_size"
  ...
  create_table "customer_contract_type_ads", force: :cascade do |t|
    t.integer  "ad_id"
